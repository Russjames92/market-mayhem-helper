...
const VOLATILITY_STOCKS = [
  ...
  { symbol:"FLUX",  name:"Flux Materials",         industries:["Manufacturing"], start:19, dividend:0, moves:{low:10, mid:8, high:6} },
  { symbol:"SPRK",  name:"SparkRoute Media",       industries:["Technology"], start:17, dividend:0, moves:{low:10, mid:8, high:6} },
  ...
  { symbol:"SKY",   name:"SkyPierce Aerospace",    industries:["Transportation","Technology"], start:28, dividend:0, moves:{low:10, mid:8, high:6} }
];
